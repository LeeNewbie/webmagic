...
/**
 * @package: us.codecraft.webmagic.pipeline
 * @ClassName: MultiPagePipelineTest
 * @Description:
 * @author: liting
 * @date: 2018-01-15 16:53
 */
public class MultiPagePipelineTest {
    @Test
    public void TestMultiPagePipeLine() {
        Pipeline pipeline = new MultiPagePipeline();
        Page page = new SimpleHttpClient().get("");
    }
    ...
    public void test() {
        ...
        MultiPagePipeline pipeline = new MultiPagePipeline();
        pipeline.process(page.getResultItems(), new Task() {
            @Override
